...
class pulsar_processing(gr.top_block, Qt.QWidget):

    def __init__(self, samp_rate=1000000):
        gr.top_block.__init__(self, "Pulsar Processing", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Pulsar Processing")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pulsar_processing")
        ...
        self.connect((self.blocks_complex_to_mag_squared_0, 0), (self.qtgui_sink_x_0_0, 0))
...
def main(top_block_cls=pulsar_processing, options=None):
    if options is None:
