...
class blk(gr.sync_block):  # other base classes are basic_block, decim_block, interp_block
    ...
    def __init__(self, data_dir='/Volumes/NO NAME/pulsar/2022-05-26/usrp-rx0-r_20220526T200000_20220526T210800/rf_data', chan='misa-l2', repeat=False):  # only default arguments here
