...
class opt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "opt")
        ...
        self.gr_digital_rf_digital_rf_source_0_0.set_block_alias("/Volumes/NO NAME/pulsar")
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_interleaved_short_to_complex_0, 0), (self.qtgui_sink_x_0, 0))
...
def main(top_block_cls=opt, options=None):
