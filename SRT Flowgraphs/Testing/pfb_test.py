...
class pfb_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_3.enable_tags(False)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_3_win, 1, 1, 1, 1)
        for r in range(1, 2):
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_2_win, 2, 1, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_1_win, 3, 1, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_4_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_3_win, 4, 0, 1, 1)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_2_win, 3, 0, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.analog_sig_source_x_0_2 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 2500, .66667, -.5, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_c(samp_rate, analog.GR_SAW_WAVE, 100, 1, 3.14, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, 3000, 1.8, 0, 0)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_freq_sink_x_4, 0))
        ...
        self.connect((self.pfb_channelizer_ccf_0, 3), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.pfb_channelizer_ccf_0, 2), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.pfb_channelizer_ccf_0, 1), (self.qtgui_time_sink_x_0_2, 0))
        self.connect((self.pfb_channelizer_ccf_0, 0), (self.qtgui_time_sink_x_0_3, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.pfb_channelizer_ccf_0.set_taps(firdes.low_pass_2(6, 6*self.samp_rate, self.samp_rate/3.0, self.samp_rate/4.0, 60))
