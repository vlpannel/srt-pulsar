...
import embed_py_ex_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class embed_py_ex(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Embedded Python Block Example", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Embedded Python Block Example")
        ...
        self.settings = Qt.QSettings("GNU Radio", "embed_py_ex")
...
def main(top_block_cls=embed_py_ex, options=None):
