...
class drf_pulsar_flow_graph(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/Users/vivelpanel/Desktop/SRT Flowgraphs/drf_output_1', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_file_meta_sink_0_0 = blocks.file_meta_sink(gr.sizeof_float*1, '/Users/vivelpanel/Desktop/SRT Flowgraphs/drf_output_sub2', samp_rate, 1, blocks.GR_FILE_FLOAT, False, 1000000, pmt.dict_add(pmt.make_dict(), pmt.intern('Initial'), pmt.from_long(3)), False)
        self.blocks_file_meta_sink_0_0.set_unbuffered(False)
        self.blocks_file_meta_sink_0 = blocks.file_meta_sink(gr.sizeof_float*1, '/Users/vivelpanel/Desktop/SRT Flowgraphs/drf_output_sub1', samp_rate, 1, blocks.GR_FILE_FLOAT, False, 1000000, pmt.dict_add(pmt.make_dict(), pmt.intern('Initial'), pmt.from_long(3)), False)
