...
class test_vectorsink(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_vectorsink")
        ...
        self.blocks_stream_to_vector_0_1 = blocks.stream_to_vector(gr.sizeof_float*1, 1024)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1001, 1, 0, 0)
        ...
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.blocks_stream_to_vector_0_1, 0))
...
def main(top_block_cls=test_vectorsink, options=None):
