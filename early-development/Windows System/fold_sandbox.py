...
import fold_sandbox_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import psrdynspec
...
class fold_sandbox(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fold_sandbox")
        ...
        self.epy_block_0 = epy_block_0.fold_stream_block(per=.1, samp_rate=1000, integration_time=.5, Nbins=1024, folding=True)
        self.blocks_vector_source_x_0 = blocks.vector_source_c(np.array([1] * 69 + [3] + [1] * 30), True, 1, [])
...
def main(top_block_cls=fold_sandbox, options=None):
