...
datafile = r'E:\pulsar\2022-05-26\usrp-rx0-r_20220526T200000_20220526T210800\rf_data'
chan = 'misa-l2'
do = drf.DigitalRFReader(datafile)

channels = do.get_channels()
bounds = do.get_bounds(chan)
data = do.read_vector(bounds[0], 10, chan)
...
source = digital_rf_source(datafile, channels=chan)