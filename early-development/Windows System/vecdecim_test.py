...
class vecdecim_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "vecdecim_test")
        ...
        self.top_grid_layout.addWidget(self._qtgui_vector_sink_f_0_0_0_win, 2, 0, 1, 1)
        for r in range(2, 3):
        ...
        self.top_grid_layout.addWidget(self._qtgui_vector_sink_f_0_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_stream_to_vector_decimator_0_0 = blocks.stream_to_vector_decimator(
        ...
        self.connect((self.blocks_stream_to_vector_decimator_0, 0), (self.qtgui_vector_sink_f_0_0, 0))
        self.connect((self.blocks_stream_to_vector_decimator_0_0, 0), (self.qtgui_vector_sink_f_0_0_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_stream_to_vector_decimator_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_stream_to_vector_decimator_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_stream_to_vector_decimator_0.set_vec_rate((self.samp_rate / 1))
        self.blocks_stream_to_vector_decimator_0_0.set_sample_rate(self.samp_rate)
        self.blocks_stream_to_vector_decimator_0_0.set_vec_rate((self.samp_rate * 2))
        self.blocks_throttle_0.set_sample_rate(self.samp_rate)




def main(top_block_cls=vecdecim_test, options=None):
