...
class rtlsdr_pulsar_flow_graph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "rtlsdr_pulsar_flow_graph")
        ...
        # Variables
        ##################################################
        self.vec_length = vec_length = 714520
        self.samples = samples = 600e6
        ...
        self.blocks_vector_to_stream_1 = blocks.vector_to_stream(gr.sizeof_float*1, 714520)
        ...
        self.blocks_integrate_xx_1 = blocks.integrate_ff(83, vec_length)
        self.blocks_integrate_xx_0 = blocks.integrate_ff(10, 1)
        self.blocks_file_meta_sink_0 = blocks.file_meta_sink(gr.sizeof_float*1, '/Users/vivelpanel/Desktop/SRT Flowgraphs/pulsar_rtlsdr_outputfile', samp_rate, 1, blocks.GR_FILE_FLOAT, False, 1000000, pmt.make_dict(), False)
        ...
        self.connect((self.blocks_integrate_xx_2, 0), (self.qtgui_number_sink_0, 0))
        self.connect((self.blocks_integrate_xx_2, 0), (self.qtgui_time_sink_x_0, 0))
        ...
        self.connect((self.rtlsdr_source_0_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
...
def main(top_block_cls=rtlsdr_pulsar_flow_graph, options=None):
