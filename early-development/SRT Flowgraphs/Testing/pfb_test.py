...
class pfb_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.qtgui_sink_x_0_3 = qtgui.sink_c(
            1024, #fftsize
        ...
        self.top_grid_layout.addWidget(self._qtgui_sink_x_0_2_win, 2, 0, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.analog_sig_source_x_0_2 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 100, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 600000, 1, 0, 0)
        ...
        self.connect((self.pfb_channelizer_ccf_0, 3), (self.qtgui_sink_x_0_0, 0))
        self.connect((self.pfb_channelizer_ccf_0, 0), (self.qtgui_sink_x_0_1, 0))
        self.connect((self.pfb_channelizer_ccf_0, 2), (self.qtgui_sink_x_0_2, 0))
        self.connect((self.pfb_channelizer_ccf_0, 1), (self.qtgui_sink_x_0_3, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0_3.set_frequency_range(0, self.samp_rate)
