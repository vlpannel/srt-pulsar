...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._scale_range = Range(0, 10, .1, 1, 200)
        self._scale_win = RangeWidget(self._scale_range, self.set_scale, "'scale'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_int_to_float_0 = blocks.int_to_float(1, scale)
    ...
    def set_scale(self, scale):
        self.scale = scale
        self.blocks_int_to_float_0.set_scale(self.scale)
