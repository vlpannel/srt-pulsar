...
class simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._qtgui_sink_x_0_win, 1, 0, 1, 2)
        for r in range(1, 2):
        ...
        self.channels_channel_model2_0 = channels.channel_model2(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_vector_source_x_0 = blocks.vector_source_f(np.repeat(np.arange(0, .5, step=.0001), 1000), True, 1, [])
